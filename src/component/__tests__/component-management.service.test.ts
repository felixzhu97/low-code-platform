...
import type { DataSource, DataMapping } from "@/data/types";
import { ComponentManagementService } from "../component-management.service";
import { ComponentFactoryService } from "@/component/component-factory.service";
import { DataBindingService } from "@/data/data-binding.service";

vi.mock("@/component/component-factory.service", () => ({
...
vi.mock("@/data/data-binding.service", () => ({
  DataBindingService: {
