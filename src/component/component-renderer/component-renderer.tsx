...
import { ChartComponentRenderer } from "@/chart/chart-component-renderer";
import { FormComponentRenderer } from "@/form/form-component-renderer";
...
function ComponentRendererImpl({
  component,
  parentComponent,
  components,
  theme,
