                ...
                {props.cardType === "stats" ? (
                  ...
                  <div className="flex flex-col items-center text-center">
                    <Avatar className="h-20 w-20">
                      ...
                      <AvatarFallback>
                        {componentData?.name?.charAt(0) || "U"}
                      </AvatarFallback>
                    </Avatar>
                    <h3 className="mt-4 text-lg font-medium">
                      {componentData?.name || "用户名称"}
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {componentData?.title || "职位头衔"}
                    </p>
              ...
              {props.cardType !== "profile" && (
                <CardFooter className="border-t bg-muted/50 px-6 py-3">
                  <div className="text-xs text-muted-foreground">
                    最后更新:{" "}
                    {componentData?.updateTime || "2023-01-01 12:00:00"}
                  </div>
                </CardFooter>
              )}
            </Card>
        ...
        case "input":
          return (
            <div className="space-y-2" style={{ ...animationStyle }}>
              {props.label && (
                <Label htmlFor={component.id}>{props.label}</Label>
              )}
              <Input
                id={component.id}
                ...
                {childComponents.length > 0 && childComponents[0] ? (
                  <div
                    className={cn(
                      ...
                      !isPreviewMode && "cursor-move",
                      selectedId === childComponents[0].id &&
                        !isPreviewMode &&
                        "ring-2 ring-primary ring-offset-2"
                    )}
                    onClick={(e) => {
                ...
                {childComponents.length > 1 && childComponents[1] ? (
                  <div
                    className={cn(
                      "relative h-full w-full",
                      !isPreviewMode && "cursor-move",
                      selectedId === childComponents[1].id &&
                        !isPreviewMode &&
                        "ring-2 ring-primary ring-offset-2"
                    )}
                    onClick={(e) => {
