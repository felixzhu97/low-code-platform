...
import { useCanvasStore } from "@/canvas/infrastructure/canvas.store";
import { useThemeStore } from "@/theme/infrastructure/theme.store";
import { useDataStore } from "@/data/infrastructure/data.store";
import { useHistoryStore } from "@/common/infrastructure/history.store";
import { useUIStore } from "@/common/infrastructure/ui.store";
import { useCustomComponentsStore } from "@/component/infrastructure/custom-components.store";
/**
 * 组合所有 stores 的 hook
 * 提供统一的状态访问接口
 */
